...
<div><a href="Login.jsp" class="forgot-pw">Already have an account?</a></div>
<div>.</div>
<div><a href="homepage.html" class="forgot-pw">Home-></a></div>
...
// if(user1!=null && phone!=null  && loginPassword!=null)
// {
// try
// {
...
// 		  stmt.executeUpdate("insert into user values('"+user1+"','"+phone+"','"+loginPassword+"')");
// 			out.println("Success!");
