...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <span class="logo_name">Guider</span>
    </div>
      <ul class="nav-links">
        <li>
          <a href="#" class="active">
  ...
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        ...
        <span class="admin_name"> <%= session.getAttribute("a") %> </span>
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <ul class="details">
            <li class="topic"> I_am_a</li>
            <li><a href="#">rs.getString(4)</a></li>
          
             
          </ul>
          <ul class="details">
            <li class="topic">Enquiry</li>
            <li><a href="#">rs.getString(5)</a></li>
